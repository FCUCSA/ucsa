        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="p-4 bg-white shadow rounded-4 h-100">
              ...
              <p className="text-secondary fs-5">
                Домашня арена — <strong>«Ювілейний»</strong> міський спортивний об’єкт, призначений для проведення футбольних матчів 
                і тренувань. Він обладнаний стандартним футбольним полем та трибунами для глядачів. На стадіоні регулярно відбуваються 
                ігри місцевих команд, а також змагання дитячо-юнацьких колективів. «Ювілейний» використовується як основна база для розвитку футболу в місті.
              </p>
              <img
                src={stadium}
