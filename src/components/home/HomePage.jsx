    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <h1 className="display-4 fw-bold">ФК ЮКСА (Тарасівка)</h1>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="p-4 bg-white shadow rounded-4 h-100">
              ...
              <p className="text-secondary fs-5">
                Домашня арена — <strong>«Ювілейний»</strong> є центральною спортивною ареною міста та головним майданчиком 
                для розвитку футболу. Спортивний об’єкт має стандартне футбольне поле з якісним покриттям, трибуни для глядачів 
                та необхідну інфраструктуру для проведення тренувального процесу і офіційних матчів. Тут регулярно проходять зустрічі 
                місцевих команд, змагання дитячо-юнацьких шкіл та різноманітні футбольні турніри. «Ювілейний» відіграє важливу роль 
                у підтримці спортивного життя громади та створює належні умови для занять футболом як для професійних спортсменів, так і для молоді.
              </p>
              <img
                src={stadium}
            ...
            <div className="p-4 bg-white shadow rounded-4 h-100">
              ...
              <ul className="list-unstyled text-secondary fs-6">
                ...
                <li className="mb-2">
                  ...
                  <br />
                  <a href="tel:+380937901945">+380 63 130 33 33</a>
                </li>
                <li>
                  <strong>Директор:</strong> Семенко Євгеній Олександрович
                </li>
              </ul>
            </div>
          </div>
